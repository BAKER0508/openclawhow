...
const translations: Record<Language, Record<string, string>> = {
  en: {
    heroTitle: 'OpenClaw How: Real Automation Cases & Industry Solutions',
    heroSubtitle: 'Help indie developers, small teams and individuals find replicable AI monetization paths',
    cases: 'Cases',
    solutions: 'Solutions',
    ...
    viewRealCases: 'View Real Cases',
    findSolutions: 'Find Industry Solutions',
    casesCount: 'cases',
    solutionsCount: 'solutions',
    industriesCount: 'industries',
    // Curated sections
    editorsPicks: "Editor's Picks",
    editorsPicksZh: 'Featured Cases',
    latestUpdates: 'Latest',
    quickStart: 'Quick Start',
    quickStartDesc: 'Low barrier cases to get started quickly',
    industryGrid: 'Browse by Industry',
    viewAll: 'View All',
    // Filters
    difficulty: 'Difficulty',
    difficultyAll: 'All',
    difficultyLow: 'Low Barrier',
    difficultyMedium: 'Medium',
    difficultyHigh: 'High Barrier',
    target: 'Target',
    targetAll: 'All',
    targetSolo: 'Solo',
    targetSmallTeam: 'Small Team',
    targetEnterprise: 'Enterprise',
    // Subscription CTA
    subscribeCTA: 'Get 5 replicable AI monetization cases delivered to your inbox every week',
    subscribeEmail: 'Your email',
    subscribeButton: 'Subscribe',
    // Difficulty badges
    difficultyBadgeLow: 'Low Barrier',
    difficultyBadgeMedium: 'Medium',
    difficultyBadgeHigh: 'High Barrier',
    // Source type
    sourceVerified: 'Verified',
    sourceUserSubmitted: 'User Submitted',
    sourcePublicCase: 'Public Case',
    ...
    infoTeamSize: 'Team',
    infoTimeframe: 'Timeframe',
    infoTargetAudience: 'Target',
    infoSourceType: 'Source',
    infoVerified: 'Verified',
    infoVerifiedYes: 'Verified',
    infoVerifiedNo: 'Unverified',
    // Model labels
    modelService: 'Service',
    modelSaas: 'SaaS',
    modelContent: 'Content',
    modelAgency: 'Agency',
    modelAutomation: 'Automation',
    // How to Replicate
    howToReplicate: 'How to Replicate',
    replicateSuitableFor: 'Suitable For',
    replicateSteps: 'Core Process',
    replicateTools: 'Required Tools',
    replicateCost: 'Estimated Cost',
    replicatePitfalls: 'Common Pitfalls',
    replicateHint: 'Read the full case study above for detailed replication steps.',
    // Disclaimer
    disclaimer: 'Disclaimer',
    disclaimerText: 'Disclaimer: Content on this site is for informational purposes only and does not constitute legal, medical, or financial advice. Revenue figures vary significantly based on market conditions, execution, and resources. Some cases are sourced from public channels or user submissions and have been verified to the best of our ability.',
    // Industries
    ...
    // Tag page
    tagDescription: 'Browse all OpenClaw How cases and solutions tagged with',
    // Industry page filters
    quickFilters: 'Quick Filters',
  },
  zh: {
    heroTitle: 'OpenClaw How\uff1a\u57fa\u4e8e OpenClaw \u7684\u771f\u5b9e\u81ea\u52a8\u5316\u6848\u4f8b\u4e0e\u884c\u4e1a\u89e3\u51b3\u65b9\u6848',
    heroSubtitle: '\u5e2e\u52a9\u72ec\u7acb\u5f00\u53d1\u8005\u3001\u5c0f\u56e2\u961f\u548c\u4e2a\u4eba\u627e\u5230\u53ef\u590d\u5236\u7684 AI \u53d8\u73b0\u8def\u5f84',
    cases: '\u6848\u4f8b',
    solutions: '\u65b9\u6848',
    industries: '\u884c\u4e1a',
    browseCTA: '\u6d4f\u89c8\u6848\u4f8b\u548c\u65b9\u6848',
    ...
    targetEnterprise: '\u4f01\u4e1a',
    // Subscription CTA
    subscribeCTA: '\u6bcf\u5468\u7cbe\u9009 5 \u4e2a\u53ef\u590d\u5236\u7684 AI \u53d8\u73b0\u6848\u4f8b\uff0c\u76f4\u8fbe\u4f60\u7684\u90ae\u7bb1',
    subscribeEmail: '\u4f60\u7684\u90ae\u7bb1',
    subscribeButton: '\u8ba2\u9605',
    // Difficulty badges
    difficultyBadgeLow: '\u4f4e\u95e8\u69db',
    difficultyBadgeMedium: '\u4e2d\u7b49',
    difficultyBadgeHigh: '\u9ad8\u95e8\u69db',
    // Source type
    sourceVerified: '\u5df2\u9a8c\u8bc1',
    sourceUserSubmitted: '\u7528\u6237\u81ea\u8ff0',
    sourcePublicCase: '\u516c\u5f00\u6848\u4f8b',
    sourceInterview: '\u8bbf\u8c08',
    sourceBlog: '\u535a\u5ba2',
    sourceVideo: '\u89c6\u9891',
    // Structured info box
    ...
    modelAutomation: '\u81ea\u52a8\u5316',
    // How to Replicate
    howToReplicate: '\u5982\u4f55\u590d\u5236\u8fd9\u4e2a\u6848\u4f8b',
    replicateSuitableFor: '\u9002\u5408\u4eba\u7fa4',
    replicateSteps: '\u6838\u5fc3\u6d41\u7a0b',
    replicateTools: '\u6240\u9700\u5de5\u5177',
    replicateCost: '\u9884\u4f30\u6210\u672c',
    replicatePitfalls: '\u5e38\u89c1\u5751\u70b9',
    replicateHint: '\u8bf7\u9605\u8bfb\u4e0a\u65b9\u5b8c\u6574\u6848\u4f8b\u4e86\u89e3\u8be6\u7ec6\u590d\u5236\u6b65\u9aa4\u3002',
    // Disclaimer
    disclaimer: '\u514d\u8d23\u58f0\u660e',
    disclaimerText: '\u514d\u8d23\u58f0\u660e\uff1a\u672c\u7ad9\u5185\u5bb9\u4ec5\u4f9b\u53c2\u8003\uff0c\u4e0d\u6784\u6210\u6cd5\u5f8b\u3001\u533b\u7597\u6216\u8d22\u52a1\u5efa\u8bae\u3002\u6536\u76ca\u6570\u636e\u56e0\u5e02\u573a\u3001\u6267\u884c\u529b\u548c\u8d44\u6e90\u4e0d\u540c\u800c\u6709\u663e\u8457\u5dee\u5f02\u3002\u90e8\u5206\u6848\u4f8b\u6765\u6e90\u4e8e\u516c\u5f00\u6e20\u9053\u6216\u7528\u6237\u6295\u7a3f\uff0c\u5df2\u5c3d\u529b\u6838\u9a8c\u4f46\u4e0d\u4fdd\u8bc1\u5b8c\u5168\u51c6\u786e\u3002',
    // Industries
    ecommerce: '\u7535\u5546',
    saas: 'SaaS',
    content: '\u5185\u5bb9\u521b\u4f5c',
